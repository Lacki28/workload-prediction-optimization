...
# MSE - 200
values_x1 = [0.00914, 0.00945]
values_x2 = [0.01684, 0.01828]
values_x3 = [0.01929, 0.01961]
values_x4 = [0.02304, 0.02211]
values_x5 = [0.02721, 0.0267]
values_x6 = [0.03122, 0.02721]
...
plt.savefig('tr_minmax_univar.png')
plt.close()
...
num_columns = 4
bar_width = 0.15
column_names = ["100 epochs","200 epochs","300 epochs","400 epochs"]
colors = ['C2', 'C2', 'C2', 'C2']
alphas = [0.5, 0.6, 0.7, 0.8]


# MSE - 200
values_x1 = [0.01134, 0.00945, 0.00857, 0.00876]
values_x2 = [0.01735, 0.01828, 0.01581, 0.01538]
values_x3 = [0.0186, 0.01961, 0.01941, 0.01793]
values_x4 = [0.0339, 0.02211, 0.02526, 0.02167]
values_x5 = [0.02876, 0.0267, 0.0252, 0.02648]
values_x6 = [0.03653, 0.02721, 0.02866, 0.02978]
...
plt.xticks(x_indexes, x)
plt.legend(fontsize=9.7)
plt.savefig('tr_ep_tests_univar.png')
plt.close()
...
values_x1 = [0.00857, 0.00843]
values_x2 = [0.01581, 0.0129]
values_x3 = [ 0.01941, 0.01589]
values_x4 = [ 0.02526, 0.01919]
values_x5 = [ 0.0252, 0.02227]
values_x6 = [ 0.02866, 0.0256]
...
plt.xticks(x_indexes, x)
plt.legend(fontsize=9.7)
plt.savefig('tr_ep_tests_filter_vs_no_filter.png')
plt.close()
